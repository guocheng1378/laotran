...
用大模型做老挝语-中文翻译，并解决老挝语的**发音**（默认微软 Edge 在线 TTS，失败回退 MMS）和**不认识老挝文字的人**的朗读问题（罗马音转写 / 汉语拼音）。适合去老挝旅游、做生意、学习老挝语或做中老跨境交流的人。
...
- 🔊 **老挝语发音**：翻译结果默认用 **微软 Edge 在线 TTS**（免费、无需 Key、lo-LA 神经语音）合成老挝语，Edge 失败时回退 Meta MMS
- 🔉 中文译文自动附**汉语拼音**，并可朗读
...
- 微软 **Edge** 在线 TTS（免费 lo-LA 神经语音，无需 Key，失败回退 Meta MMS）
...
├── LaoSpeech.kt             老挝语在线发音（默认 Edge TTS，MMS 兜底）
...
- **老挝语没有声音**：需要联网（默认微软 Edge TTS，失败回退 MMS），并确认网络可访问 b.ai。
